CREATE OR REPLACE FUNCTION IPTV.FN_CHK_PREPAID_EXCL_CNT (P_SERIAL_ID VARCHAR2, P_CHECKED_DAYS NUMBER) RETURN NUMBER IS
v_return INTEGER;
/******************************************************************************
   NAME:       FN_CHK_PREPAID_EXCL_CNT
   PURPOSE:    
