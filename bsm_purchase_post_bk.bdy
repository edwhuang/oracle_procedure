CREATE OR REPLACE PACKAGE BODY IPTV.BSM_PURCHASE_POST_BK is
  ...
  begin
    ...
    BSM_client_service.Set_subscription_r(p_Pk_No,
                                          v_mac_address,
                                          refresh_client);
