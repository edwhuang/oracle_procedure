create or replace procedure iptv.p_crt_purchase_ios(p_paytype          varchar2,
...
begin
  ...
  if p_package_id is not null then
    ...
    declare
      v_id varchar2(32);
    begin
      select package_id, intro_offer, intro_offer_desc,price
  ...
  if v_loc_exp_date >= sysdate -7 and v_loc_pur_date >= to_date('2011/08/01', 'YYYY/MM/DD') then
