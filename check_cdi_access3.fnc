CREATE OR REPLACE FUNCTION IPTV."CHECK_CDI_ACCESS3" (p_client_id varchar2,p_asset_id varchar2) RETURN varchar2
is
  result varchar2(32);
...
select 'Y' into result
 ...
 where mac_address = v_client_id
   ...
   and ((decode(b.cal_type,'T',a.item_id,a.package_id) in (select "parent_id"
