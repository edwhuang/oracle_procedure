CREATE OR REPLACE PACKAGE BODY IPTV.PARTNER_SERVICE_OLD is
  ...
  begin
    ...
    begin
      ...
      begin
         v_vendor_package_id := json_ext.get_string(j_order, 'vendor_package_id');
       exception
        when others then
          v_vendor_package_id := '';
      end;
    ...
    if v_action = 'create' then
      ...
      begin
        ...
        update bsm_recurrent_mas c
           set c.status_flg = 'P', c.remark = 'RESUME SERVUCE'
