CREATE OR REPLACE FUNCTION IPTV.FN_CHK_FUTURE_PAID_PUR_CNT2 (P_SERIAL_ID VARCHAR2, P_PUR_NO VARCHAR2, P_CHECKED_DATE DATE) RETURN NUMBER IS
v_return INTEGER;
/******************************************************************************
...
BEGIN
   ...
   EXCEPTION
     ...
     WHEN OTHERS THEN
       ...
       RAISE;
END FN_CHK_FUTURE_PAID_PUR_CNT2;
/
