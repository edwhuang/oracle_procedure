CREATE OR REPLACE PROCEDURE IPTV."REFRESH_BSM_SERVER"
(server varchar2)
...
BEGIN
 ...
 req := utl_http.begin_request('http://'||server||'.tw.svc.litv.tv/BSM_JSON_SERVICE/BSM_PURCHASE_Info.ashx','POST','HTTP/1.1');
...
'{  "id":"1234",
    "jsonrpc": "2.0",
    "method": "post_package_group_special",
    "params": {}
}';
BEGIN
  content_2 :=content;
