create or replace procedure iptv.modify_service_1111_p4(pi_client_id varchar2 default null) is
begin
  --2A0070E70FDC624D
if pi_client_id in ( '2A0070E70FDC624D') then
  null;
 -- modify_service_1111_p6(pi_client_id);
else
  DECLARE
    cursor c0 is
