CREATE OR REPLACE PACKAGE BODY IPTV.TSTAR_ORDER_SERVICE_2 is
  ...
  /*    begin
    ...
    --                                                  '台灣之星LiTV會員,通知您已成功開通優惠專案。提醒您:(1)先下載 LiTV APP。(2)以此手機門號註冊成為 LiTV 會員，登入後即可開始使用。下載LiTV App連結 http://smarturl.it/litvtstar');
        ...
        declare
          ...
          v_seq                 number(16);
         p_packages            varchar2(1024) := 'SVC20161103170055042,WDS001,R,0,M,0,199
...
SVC20180312100800789,WDS005,O,0,S,0,179
SVC20180312100800789,WDS005,R,1,M,31,179
SVC20180319194019475,WDS005,O,0,S,0,159
SVC20180319185710125,WDS005,O,0,S,0,179
SVC20180319185710125,WDS005,R,1,M,31,179
SVC20180309154616550,WDS005,O,0,S,0,159
SVC20180426104121726,CD0008,O,0,M,0,120
